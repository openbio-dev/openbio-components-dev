...
import { b as constants } from './chunk-12b05e12.js';
...
class WS {
    ...
    init() {
        console.warn("websocket connection closed", hooks().format());
        try {
        ...
        this.deviceSocket.addEventListener("close", () => {
            ...
            console.info("device websocket connection closed", hooks().format());
        });
...
export { getAppConfig as a, WS as b, notify as c, showImage as d };
