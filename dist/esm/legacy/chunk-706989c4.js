...
var config, url, localUrl, sendToRemote, authServicesUrl;
var localServicesUrl = "http://" + constants.WS_HOST;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sendToRemote = !config.apiService && !config.asyncPersistency;
                    _a.label = 2;
                case 2: return [2 /*return*/, fetch((sendToRemote ? url : localUrl) + "/device/flow-options").then(function (res) { return res.json(); })];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sendToRemote = !config.apiService && !config.asyncPersistency;
                    _a.label = 2;
                case 2: return [2 /*return*/, fetch((sendToRemote ? url : localUrl) + "/db/api/biometries/fingers", {
                        method: 'post',
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    authServicesUrl = config.urls.authServicesUrl;
                    _a.label = 2;
                case 2: return [2 /*return*/, fetch(url + "/db/api/people-details/" + cpf + "/" + captureType, {
                        method: 'get',
                        headers: { 'Content-Type': 'application/json' },
                    }).then(function (res) { return res.json(); })];
            }
...
function fingerAuthenticate(data) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authServicesToken()];
                case 1:
                    _a.sent();
                    return [2 /*return*/, fetch(authServicesUrl + "/finger/authenticate", {
                            method: 'post',
                            body: JSON.stringify(data),
                            headers: { 'Content-Type': 'application/json' },
                            credentials: 'include',
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sendToRemote = !config.apiService && !config.asyncPersistency;
                    _a.label = 2;
                case 2: return [2 /*return*/, fetch((sendToRemote ? url : localUrl) + "/db/api/biometries/finger-file", {
                        method: 'post',
                        body: bodyData,
                    })
                        .then(function (res) { return res.json(); })];
...
export { authLog as a, getAnomalies as b, saveFingers as c, getPeople as d, getFlowOptions as e, fingerAuthenticate as f, getModalSettings as g, saveFingerFile as s };
