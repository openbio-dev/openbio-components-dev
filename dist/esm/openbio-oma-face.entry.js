import { r as registerInstance, f as forceUpdate, h as h$1, g as getElement } from './index-2f72a0cb.js';
...
const OpenbioFaceOmaComponent = class {
    ...
    render() {
        const deviceOptions = (this.deviceList || []).map((device) => {
            return (h$1("option", { value: device.deviceId, selected: this.selectedDevice === device.deviceId }, device.label || device.deviceId));
        });
        const overlay = () => {
            return h$1("svg", { width: "100%", height: "100%", viewBox: "0 0 640 480", version: "1.1", xmlns: "http://www.w3.org/2000/svg" }, h$1("defs", null, h$1("mask", { id: "overlay-mask", x: "0", y: "0", width: "100%", height: "100%" }, h$1("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: "#fff" }), h$1("rect", { x: "30%", y: "15%", width: "250", height: "333" }))), h$1("rect", { x: "0", y: "0", width: "100%", height: "99%", mask: "url(#overlay-mask)" }));
        };
        return (h$1("div", { style: { "background-color": this.containerBackgroundColor || "#FFFFFF" } }, h$1("div", { class: "window-size", style: { "padding": '0' } }, h$1("loader-component", { enabled: this.showFullscreenLoader }), h$1("div", { id: "notification-container" }), this.showHeader && h$1("nav", { class: 'navbar', style: { "background-color": this.primaryColor || "#0D3F56" } }, h$1("div", { class: 'title is-3 has-text-centered', style: { "width": "100%", "color": this.textColor || "#FFFFFF", "padding-top": "7px" } }, this.headerTitle || this.translations.BIOMETRIC_AUTHENTICATION)), h$1("div", { class: 'level', style: { "margin-top": "30px" } }, h$1("div", { class: 'rows has-text-centered', style: { width: "100%" } }, this.deviceList && this.deviceList.length > 0 &&
            h$1("div", { class: "columns is-mobile is-centered" }, h$1("div", { class: "column" }, h$1("span", { style: { fontSize: '0.9em' } }, " C\u00E2mera: "), h$1("div", { class: "select is-small inline" }, h$1("select", { onChange: this.setDevice.bind(this), name: "device" }, deviceOptions)))), h$1("div", { class: "row", style: { display: "inline-block" } }, h$1("div", { style: {
                position: "relative",
            ...
            } }, h$1("canvas", { class: "face-canvas", width: "333", height: "250", style: { display: "inline-block" } }), h$1("video", { id: "video", ref: el => { this.videoElement = el; }, class: "webcam-video", autoplay: true, muted: true, style: {
                display: this.captured ? "none" : "inline-block",
                height: '480px !important'
            } }), h$1("div", { style: { position: "absolute", top: "0", right: "0", bottom: "0", left: "0", opacity: "0.7" } }, overlay()), this.lowerCameraQualityDetected &&
            h$1("div", { style: { position: "absolute", top: "0", right: "0", bottom: "0", left: "0", opacity: "0.7", backgroundColor: "red", height: "30px", color: "white", paddingTop: "2px", fontWeight: "600" } }, h$1("img", { src: "./assets/general/alert-outline.png", class: "icon-24", style: { marginRight: "5px" }, "aria-hidden": "true" }), "A c\u00E2mera detectada n\u00E3o possui o requisito m\u00EDnimo recomendado de 1080p")), h$1("img", { id: "img", height: "300px", class: "webcam-snapshot object-fit-contain", style: {
                ...
                marginBottom: "5px",
                objectFit: 'contain'
            } })), h$1("div", { class: "row has-text-centered", style: { 'margin-top': '1vh', 'padding-bottom': '2vh' } }, h$1("a", { class: `btn-primary`, style: {
    ...
    get componentContainer() { return getElement(this); }
...
export { OpenbioFaceOmaComponent as openbio_oma_face };
