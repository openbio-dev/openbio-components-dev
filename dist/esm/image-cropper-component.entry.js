import { r as registerInstance, h, g as getElement } from './chunk-654cd872.js';
import { c as createCommonjsModule, a as commonjsGlobal, S as Swal } from './chunk-00a4f160.js';
import { T as TranslationUtils } from './chunk-58df5f73.js';
...
class ImageCropperComponent {
    ...
    render() {
        return (h("div", null, h("img", { src: this.src, class: "cropper-base-image my-3", style: { maxHeight: "30vh" } }), h("div", null), h("div", { class: "toolbox-container" }, h("div", { class: "button-container", onClick: () => this.crop() }, h("img", { src: "./assets/general/crop.png", class: "icon-24", "aria-hidden": "true", title: this.translations.CLIP })), h("div", { class: "button-container", onClick: () => this.cropper.rotate(-1) }, h("img", { src: "./assets/general/rotate-left.png", class: "icon-24", "aria-hidden": "true", title: this.translations.ADJUSTMENT_1_DEGREE_LEFT })), h("div", { class: "button-container", onClick: () => this.cropper.rotate(1) }, h("img", { src: "./assets/general/rotate-right.png", class: "icon-24", "aria-hidden": "true", title: this.translations.ADJUSTMENT_1_DEGREE_RIGHT })), h("div", { class: "button-container", onClick: () => this.cropper.rotate(-90) }, h("img", { src: "./assets/general/rotate-left-variant.png", class: "icon-24", "aria-hidden": "true", title: this.translations.TURN_90_DEGREE_LEFT })), h("div", { class: "button-container", onClick: () => this.cropper.rotate(90) }, h("img", { src: "./assets/general/rotate-right-variant.png", class: "icon-24", "aria-hidden": "true", title: this.translations.TURN_90_DEGREE_RIGHT })), h("div", { class: "field" }, h("input", { class: `is-checkradio has-background-color ${this.segment ? "is-info" : ""}`, id: "check-segment", type: "checkbox", name: "check-segment", checked: this.segment, onChange: () => this.segmentCheckInput() }), h("label", { htmlFor: "check-segment" }, this.translations.USE_SEGMENTATION)))));
    }
...
export { ImageCropperComponent as image_cropper_component };
