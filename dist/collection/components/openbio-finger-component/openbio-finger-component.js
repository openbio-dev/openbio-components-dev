import { getFlowOptions, getAnomalies, saveFingers, getModalSettings } from "./api";
...
export class OpenbioFingerComponent {
    ...
    executeRepetitionControl() {
        ...
        this.payload.data = {
            ...
            disabledControl: this.disabledControls || !!this.anomaly
        };
        if (this.isEditing)
            this.payload.fingerIndex = this.currentFingerSequence[0];
        this.ws.respondToDeviceWS(this.payload);
    ...
    async componentDidLoad() {
        ...
        this.ws.deviceSocket.addEventListener("message", (event) => {
            ...
            if (deviceStatuses && !deviceStatuses.finger && !deviceStatuses.finger.initialized) {
    ...
    storeCapturedFinger(saveFingersResult) {
        ...
        this.unmatchCount = 0;
        this.repeatedCount = 0;
        if (this.currentFingerSequence.length > 0) {
            this.startPreview();
        }
    }
        ...
        return (h("div", { class: "window-size" },
            ...
            this.tab === 0 ? h("div", { class: "columns is-mobile" },
                    ...
                    h("div", { class: "evaluation" },
                        ...
                        h("div", { class: "hand-status" },
                            ...
                            h("ul", null,
                                ...
                                h("li", { class: `status-item status${this.capturedNfiq(9)}` }, this.capturedNfiq(9)))))),
                h("div", { class: "column text-align-left" },
                    ...
                    h("div", { class: "columns is-mobile action-buttons-container" }, this.detached && !this.isTagComponent ? h("div", { class: "column has-text-centered" },
                        ...
                        h("div", { class: "column" },
                            h("div", { class: "select is-small inline is-pulled-left" },
                                h("select", { onChange: this.setSelection.bind(this), name: "anomaly" },
                                    ...
                                    anomalyOptions))),
                        h("div", { class: "column" },
                            h("a", { class: "button is-small is-pulled-right action-button", onClick: () => this.saveAnomaly() }, "SALVAR ANOMALIA"))),
            ...
            this.tab === 2 ? h("div", { class: "tab-content" },
                h("div", { class: "capture-result-container" },
                    ...
                    h("div", { class: "columns is-mobile is-multiline is-left" },
                        ...
                        h("openbio-finger-image-component", { finger: this.getFlatFingerFromIndex(9), fingerName: this.fingerNames[9], editFingerCallback: this.editFinger, parentComponentContext: this })))) : null));
    }
