...
const index = require('./index-5ade4e58.js');
...
const ptBR = {
    ...
    "HYPOTHENAR_RIGHT": "Hipotenar direita",
    "HYPOTHENAR_LEFT": "Hipotenar esquerda",
...
const openbioOmaFaceComponentScss = ".canvas{border:1px solid #cccccc}.face-canvas{position:absolute}.margin-left-fix{margin-left:-30px !important}.webcam-snapshot{margin-top:8px}.btn-primary{-ms-flex-align:center;align-items:center;border-radius:4px;display:-ms-inline-flexbox;display:inline-flex;-ms-flex:0 0 auto;flex:0 0 auto;font-size:0.75rem;letter-spacing:.0892857143em;-ms-flex-pack:center;justify-content:center;outline:0;padding:5px;position:relative;text-decoration:none;text-indent:.0892857143em;text-transform:uppercase;-webkit-transition-duration:.28s;transition-duration:.28s;-webkit-transition-property:opacity,-webkit-box-shadow,-webkit-transform;transition-property:opacity,-webkit-box-shadow,-webkit-transform;transition-property:box-shadow,transform,opacity;transition-property:box-shadow,transform,opacity,-webkit-box-shadow,-webkit-transform;-webkit-transition-timing-function:cubic-bezier(.4,0,.2,1);transition-timing-function:cubic-bezier(.4,0,.2,1);-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;vertical-align:middle;white-space:nowrap;-webkit-box-shadow:0 2px 4px -1px rgba(0, 0, 0, 0.3), 0 4px 5px 0 rgba(0, 0, 0, 0.3), 0 1px 10px 0 rgba(0, 0, 0, 0.3);box-shadow:0 2px 4px -1px rgba(0, 0, 0, 0.3), 0 4px 5px 0 rgba(0, 0, 0, 0.3), 0 1px 10px 0 rgba(0, 0, 0, 0.3);color:#FFFFFF}.btn-primary:hover{color:#FFFFFF !important}span,h6,label,option,select,a,p{font-family:\"Poppins\" !important}.object-fit-contain{-o-object-fit:contain !important;object-fit:contain !important}video{width:640px !important;height:480px !important}";
...
const OpenbioFaceOmaComponent = class {
    constructor(hostRef) {
    ...
    startFaceApi() {
        Promise.all([
            nets.tinyFaceDetector.loadFromUri(this.MODEL_URL),
            nets.faceRecognitionNet.loadFromUri(this.MODEL_URL),
            ...
            navigator.mediaDevices.getUserMedia({
                ...
                setTimeout(async () => {
                    ...
                    this.videoInterval = setInterval(async () => {
                        this.screenUpdate();
                        const detections = await detectAllFaces(videoElement, new TinyFaceDetectorOptions());
                        ...
                        if (resizedDetections.length) {
                            ...
                            const drawBox = new DrawBox(box, drawOptions);
                            drawBox.draw(canvas);
                        }
                    }, 100);
                }, 1 * 1000);
    ...
    render() {
        const deviceOptions = (this.deviceList || []).map((device) => {
            return (index.h("option", { value: device.deviceId, selected: this.selectedDevice === device.deviceId }, device.label || device.deviceId));
        });
        const overlay = () => {
            return index.h("svg", { width: "100%", height: "100%", viewBox: "0 0 640 480", version: "1.1", xmlns: "http://www.w3.org/2000/svg" }, index.h("defs", null, index.h("mask", { id: "overlay-mask", x: "0", y: "0", width: "100%", height: "100%" }, index.h("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: "#fff" }), index.h("rect", { x: "30%", y: "15%", width: "250", height: "333" }))), index.h("rect", { x: "0", y: "0", width: "100%", height: "99%", mask: "url(#overlay-mask)" }));
        };
        return (index.h("div", { style: { "background-color": this.containerBackgroundColor || "#FFFFFF" } }, index.h("div", { class: "window-size", style: { "padding": '0' } }, index.h("loader-component", { enabled: this.showFullscreenLoader }), index.h("div", { id: "notification-container" }), this.showHeader && index.h("nav", { class: 'navbar', style: { "background-color": this.primaryColor || "#0D3F56" } }, index.h("div", { class: 'title is-3 has-text-centered', style: { "width": "100%", "color": this.textColor || "#FFFFFF", "padding-top": "7px" } }, this.headerTitle || this.translations.BIOMETRIC_AUTHENTICATION)), index.h("div", { class: 'level', style: { "margin-top": "30px" } }, index.h("div", { class: 'rows has-text-centered', style: { width: "100%" } }, this.deviceList && this.deviceList.length > 0 &&
            index.h("div", { class: "columns is-mobile is-centered" }, index.h("div", { class: "column" }, index.h("span", { style: { fontSize: '0.9em' } }, " C\u00E2mera: "), index.h("div", { class: "select is-small inline" }, index.h("select", { onChange: this.setDevice.bind(this), name: "device" }, deviceOptions)))), index.h("div", { class: "row", style: { display: "inline-block" } }, index.h("div", { style: {
                position: "relative",
            ...
            } }, index.h("canvas", { class: "face-canvas", width: "333", height: "250", style: { display: "inline-block" } }), index.h("video", { id: "video", ref: el => { this.videoElement = el; }, class: "webcam-video", autoplay: true, muted: true, style: {
                display: this.captured ? "none" : "inline-block",
                height: '480px !important'
            } }), index.h("div", { style: { position: "absolute", top: "0", right: "0", bottom: "0", left: "0", opacity: "0.7" } }, overlay()), this.lowerCameraQualityDetected &&
            index.h("div", { style: { position: "absolute", top: "0", right: "0", bottom: "0", left: "0", opacity: "0.7", backgroundColor: "red", height: "30px", color: "white", paddingTop: "2px", fontWeight: "600" } }, index.h("img", { src: "./assets/general/alert-outline.png", class: "icon-24", style: { marginRight: "5px" }, "aria-hidden": "true" }), "A c\u00E2mera detectada n\u00E3o possui o requisito m\u00EDnimo recomendado de 1080p")), index.h("img", { id: "img", height: "300px", class: "webcam-snapshot object-fit-contain", style: {
                ...
                marginBottom: "5px",
                objectFit: 'contain'
            } })), index.h("div", { class: "row has-text-centered", style: { 'margin-top': '1vh', 'padding-bottom': '2vh' } }, index.h("a", { class: `btn-primary`, style: {
    ...
    get componentContainer() { return index.getElement(this); }
    static get watchers() { return {
        "locale": ["listenLocale"]
    }; }
};
OpenbioFaceOmaComponent.style = openbioOmaFaceComponentScss;

exports.openbio_oma_face = OpenbioFaceOmaComponent;
