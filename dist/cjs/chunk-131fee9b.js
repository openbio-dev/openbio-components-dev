...
class WS {
    ...
    init() {
        ...
        try {
            this.deviceSocket = new WebSocket(`ws://${__chunk_6.constants.WS_HOST}/device`);
        }
        catch (error) {
        ...
        this.componentSocket = new WebSocket(`ws://${__chunk_6.constants.WS_HOST}/component`);
        ...
        this.interfaceSocket = new WebSocket(`ws://${__chunk_6.constants.WS_HOST}/interface`);
