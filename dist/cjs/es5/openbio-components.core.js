...
} var s = e.namespace || "OpenbioComponents"; return D || (D = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    t.addEventListener("e", null, Object.defineProperty({}, "passive", { get: function () { return i.Nn = !0; } }));
        ...
        n.mn.set(t, !0), N(n, t), M(n.Sn.get(t), !0);
        var e = n.gn.get(t);
    ...
    } })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o, u) { if (P(n, t) && (i = n.gn.get(t)) && !n.mn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.ot.set(t, !0), (u = n.st.has(t)) || (n.st.set(t, !0), t["s-ld"] = void 0, n.Z.En(t, e));
        try {
            M(n.Sn.get(t)), (o = n.at.get(t)) && (o.forEach(function (n) { return n(t); }), n.at.delete(t)), !u && i.componentDidLoad && i.componentDidLoad();
        }
        catch (e) {
            n.kn(e, 4, t);
        }
    ...
    for (o = 0; o < i.length; o++)
        i[o][1](null);
    i.length = 0;
} }(b, d, r, r["s-apps"], r["s-cr"]), d.initialized = !0, b; }, L = {}, D = !1;
