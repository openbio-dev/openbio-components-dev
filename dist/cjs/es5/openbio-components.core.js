...
} var s = e.namespace || "OpenbioComponents"; return L || (L = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    case 0: return n.wn.delete(r), n.bn.has(r) ? [3, 12] : (a = n.Mn.get(r)) ? [3, 6] : (s = n.gn.get(r)) && !s["s-rn"] ? ((s["s-rc"] = s["s-rc"] || []).push(function () { S(n, r, f); }), [2]) : (a = W(n, r, n.jn.get(r), f), [3, 5]);
    ...
    case 12: return [2];
} }); }); }, O = function (n, t, e, r, i, o, u) { (u = n.On.get(t)) || n.On.set(t, u = {}); var f = u[e]; if (r !== f && (u[e] = r, o = n.Mn.get(t))) {
    var c = u[T + e];
    if (c)
    ...
    !n.Cn && t["s-rn"] && C(n, t, i);
} }, _ = function (n, t, e, r) { Object.defineProperty(n, t, { configurable: !0, get: e, set: r }); }, T = "wc-", W = function (n, t, e, r, i, o) { try {
    i = new (o = n.nn(t).$n), function (n, t, e, r, i, o) { n._n.set(r, e), n.On.has(e) || n.On.set(e, {}), Object.entries(Object.assign({ color: { type: String } }, t.properties, { mode: { type: String } })).forEach(function (t) { var u = t[0], f = t[1]; (function (n, t, e, r, i, o, u, f, c) { if (t.type || t.state) {
        var a = n.On.get(e);
        t.state || (!t.attr || void 0 !== a[i] && "" !== a[i] || (f = o && o.Tn) && l(c = f[t.attr]) && (a[i] = E(t.type, c)), e.hasOwnProperty(i) && (void 0 === a[i] && (a[i] = E(t.type, e[i])), "mode" !== i && delete e[i])), r.hasOwnProperty(i) && void 0 === a[i] && (a[i] = r[i]), t.watchCallbacks && (a[T + i] = t.watchCallbacks.slice()), _(r, i, function s(t) { return (t = n.On.get(n._n.get(this))) && t[i]; }, function v(e, r) { (r = n._n.get(this)) && (t.state || t.mutable) && O(n, r, i, e, u); });
    }
    else
...
} return !0; }, P = function (n, t, e, r, i, o) { if (n.yn.delete(t), (i = n.gn.get(t)) && ((r = i["s-ld"]) && ((e = r.indexOf(t)) > -1 && r.splice(e, 1), r.length || i["s-init"] && i["s-init"]()), n.gn.delete(t)), n.xn.length && !n.yn.size)
    for (; o = n.xn.shift();)
        ...
        catch (n) { } return 1 === t.G && n.Y && !e.shadowRoot && n.tt(e, { mode: "open" }), r = { Tn: {} }, t.tn && Object.keys(t.tn).forEach(function (o) { (i = t.tn[o].un) && (r.Tn[i] = n.Zn(e, i)); }), r; }(n.Z, t, e)), n.ot(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { if (!n.ut && function (n, t) { for (; t;) {
        if (!n.Un(t))
            return 9 !== n.Nn(t);
        t = n.Un(t);
    } }(n.Z, t)) {
        n.bn.set(t, !0), P(n, t), M(n.Sn.get(t), !0);
        var e = n.Mn.get(t);
        e && e.componentDidUnload && e.componentDidUnload(), n.Z.on(t), n.ft.delete(t), n.l && n.l.removeHost(t), [n.gn, n.ct, n.jn].forEach(function (n) { return n.delete(t); });
    } })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o, u) { if (x(n, t) && (i = n.Mn.get(t)) && !n.bn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
    ...
    for (o = 0; o < i.length; o++)
        i[o][1](null);
    i.length = 0;
} }(w, p, r, r["s-apps"], r["s-cr"]), p.initialized = !0, w; }, R = {}, L = !1;
