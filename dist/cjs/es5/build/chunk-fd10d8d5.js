...
var chunk_85a3c3cb_js_1 = require("./chunk-85a3c3cb.js");
...
function getEraName() { var e, t, a, o = this.localeData().eras(); for (e = 0, t = o.length; e < t; ++e) {
    if (a = this.startOf("day").valueOf(), o[e].since <= a && a <= o[e].until)
        return o[e].name;
...
function getEraYear() { var e, t, a, o, n = this.localeData().eras(); for (e = 0, t = n.length; e < t; ++e)
    if (a = n[e].since <= n[e].until ? 1 : -1, o = this.startOf("day").valueOf(), n[e].since <= o && o <= n[e].until || n[e].until <= o && o <= n[e].since)
...
proto$2.isValid = isValid$1, proto$2.abs = abs, proto$2.add = add$1, proto$2.subtract = subtract$1, proto$2.as = as, proto$2.asMilliseconds = asMilliseconds, proto$2.asSeconds = asSeconds, proto$2.asMinutes = asMinutes, proto$2.asHours = asHours, proto$2.asDays = asDays, proto$2.asWeeks = asWeeks, proto$2.asMonths = asMonths, proto$2.asQuarters = asQuarters, proto$2.asYears = asYears, proto$2.valueOf = valueOf$1, proto$2._bubble = bubble, proto$2.clone = clone$1, proto$2.get = get$2, proto$2.milliseconds = milliseconds, proto$2.seconds = seconds, proto$2.minutes = minutes, proto$2.hours = hours, proto$2.days = days, proto$2.weeks = weeks, proto$2.months = months, proto$2.years = years, proto$2.humanize = humanize, proto$2.toISOString = toISOString$1, proto$2.toString = toISOString$1, proto$2.toJSON = toISOString$1, proto$2.locale = locale, proto$2.localeData = localeData, proto$2.toIsoString = deprecate("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", toISOString$1), proto$2.lang = lang, addFormatToken("X", 0, 0, "unix"), addFormatToken("x", 0, 0, "valueOf"), addRegexToken("x", matchSigned), addRegexToken("X", matchTimestamp), addParseToken("X", function (e, t, a) { a._d = new Date(1e3 * parseFloat(e)); }), addParseToken("x", function (e, t, a) { a._d = new Date(toInt(e)); }), hooks.version = "2.26.0", setHookCallback(createLocal), hooks.fn = proto, hooks.min = min, hooks.max = max, hooks.now = now, hooks.utc = createUTC, hooks.unix = createUnix, hooks.months = listMonths, hooks.isDate = isDate, hooks.locale = getSetGlobalLocale, hooks.invalid = createInvalid, hooks.duration = createDuration, hooks.isMoment = isMoment, hooks.weekdays = listWeekdays, hooks.parseZone = createInZone, hooks.localeData = getLocale, hooks.isDuration = isDuration, hooks.monthsShort = listMonthsShort, hooks.weekdaysMin = listWeekdaysMin, hooks.defineLocale = defineLocale, hooks.updateLocale = updateLocale, hooks.locales = listLocales, hooks.weekdaysShort = listWeekdaysShort, hooks.normalizeUnits = normalizeUnits, hooks.relativeTimeRounding = getSetRelativeTimeRounding, hooks.relativeTimeThreshold = getSetRelativeTimeThreshold, hooks.calendarFormat = getCalendarFormat, hooks.prototype = proto, hooks.HTML5_FMT = { DATETIME_LOCAL: "YYYY-MM-DDTHH:mm", DATETIME_LOCAL_SECONDS: "YYYY-MM-DDTHH:mm:ss", DATETIME_LOCAL_MS: "YYYY-MM-DDTHH:mm:ss.SSS", DATE: "YYYY-MM-DD", TIME: "HH:mm", TIME_SECONDS: "HH:mm:ss", TIME_MS: "HH:mm:ss.SSS", WEEK: "GGGG-[W]WW", MONTH: "YYYY-MM" };
var WS = function () { function e() { this.init(); } return e.prototype.init = function () { var e = this; console.info("websocket will try connection", hooks().format()); try {
    this.deviceSocket = new WebSocket("ws://" + chunk_85a3c3cb_js_1.a.WS_HOST + "/device");
}
catch (e) {
    console.log("Component WS error", e);
} this.deviceSocket.addEventListener("close", function () { e.deviceSocket.close(), console.warn("device websocket connection closed", hooks().format()); }), this.deviceSocket.addEventListener("error", function () { e.deviceSocket.close(); }), this.deviceSocket.addEventListener("open", function () { console.info("device websocket connection opened", hooks().format()); }), this.componentSocket = new WebSocket("ws://" + chunk_85a3c3cb_js_1.a.WS_HOST + "/component"), this.componentSocket.addEventListener("close", function () { e.componentSocket.close(); }), this.componentSocket.addEventListener("error", function () { e.componentSocket.close(); }), this.componentSocket.addEventListener("open", function () { console.info("component websocket connection opened", hooks().format()); }), this.interfaceSocket = new WebSocket("ws://" + chunk_85a3c3cb_js_1.a.WS_HOST + "/interface"), this.interfaceSocket.addEventListener("close", function () { e.interfaceSocket.close(); }), this.interfaceSocket.addEventListener("open", function () { console.info("interface websocket connection opened", hooks().format()); }), this.interfaceSocket.addEventListener("error", function () { e.interfaceSocket.close(); }); }, e.prototype.respondToDeviceWS = function (e) { e instanceof ArrayBuffer && void 0 !== e.byteLength ? this.deviceSocket.send(e) : this.deviceSocket.send(JSON.stringify(e)); }, e.prototype.respondToComponentWS = function (e) { this.componentSocket.send(JSON.stringify(e)); }, e.prototype.changeModuleTo = function (e) { this.interfaceSocket.send(JSON.stringify(e)); }, e.prototype.status = function () { return this.deviceSocket.readyState; }, e; }();
exports.a = WS;
