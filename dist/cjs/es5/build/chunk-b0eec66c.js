...
var chunk_10833c3c_js_1 = require("./chunk-10833c3c.js");
var config, url, localUrl, sendToRemote, authServicesUrl, localServicesUrl = "http://" + chunk_85a3c3cb_js_1.a.WS_HOST;
function getFlowOptions() { return tslib_1.__awaiter(this, void 0, void 0, function () { return tslib_1.__generator(this, function (e) { switch (e.label) {
    case 0: return url ? [3, 2] : [4, chunk_10833c3c_js_1.a()];
...
function getModalSettings() { return fetch(localServicesUrl + "/db/api/settings/" + chunk_85a3c3cb_js_1.a.settingTypes.MODAL_SETTINGS, { method: "get", headers: { "Content-Type": "application/json" } }).then(function (e) { return e.json(); }); }
...
function saveFingerFile(e, t) { return tslib_1.__awaiter(this, void 0, void 0, function () { var n; return tslib_1.__generator(this, function (i) { switch (i.label) {
    case 0: return (n = new FormData).append("file", t), n.set("data", JSON.stringify(e)), url ? [3, 2] : [4, chunk_10833c3c_js_1.a()];
...
exports.b = authLog;
chunk_10833c3c_js_1.a().then(function (e) { url = (config = e).serviceServerType + "://" + config.urls.apiService + ":" + config.ports.apiService, localUrl = "http://" + config.urls.localService + ":" + config.ports.localService, authServicesUrl = config.urls.authServicesUrl, sendToRemote = !config.apiService && !config.asyncPersistency; });
