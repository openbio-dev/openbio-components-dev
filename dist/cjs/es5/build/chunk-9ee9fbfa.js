...
var chunk_e60f7399_js_1 = require("./chunk-e60f7399.js");
var config, url;
...
chunk_e60f7399_js_1.a().then(function (e) { url = (config = e).serviceServerType + "://" + config.urls.apiService + ":" + config.ports.apiService; });
