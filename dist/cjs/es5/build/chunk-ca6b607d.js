...
var url = "http://" + chunk_e4627dab_js_1.a.WS_HOST;
...
function showImage(t, e, n, a, i) { var o = t.getContext("2d"); if (e) {
    ...
    o.drawVerticalLine = function (t, e, n, a) { this.fillStyle = a, this.fillRect(t, e, 1, n); }, r.onload = function () { !function (t, e) { var r, h, c, s, d = e.width / e.height, g = t.width / t.height; d < g ? (c = (t.width - (h = e.width * ((r = t.height) / e.height))) / 2, s = 0) : d > g ? (c = 0, s = (t.height - (r = e.height * ((h = t.width) / e.width))) / 2) : (r = t.height, h = t.width, c = 0, s = 0); for (var f = o.createImageData(t.width, t.height), u = f.data.length; --u >= 0;)
        f.data[u] = 0; o.putImageData(f, 0, 0), o.drawImage(e, c, s, h, r), a && n && o.drawVerticalLine(.575 * a, c - 60, r, n > 1 ? "green" : "red"), 0 === n && o.drawVerticalLine(0, 0, r, "white"), i && i.eyes.length > 0 && i.eyes.forEach(function (t) { o.strokeStyle = "red", o.beginPath(), o.arc(t.x, t.y, 5, 0, 2 * Math.PI), o.stroke(); }); }(t, r); }, r.src = h;
}
else
